          ...
          <div className={`${s.container} ${s.containerPrimary}`}>
            <div className={s.textContainer}>
              ...
              <Paragraph>
                ...
                housewife with 6 children. Benjamin beat all odds and
                transformed his reality through volleyball.
              </Paragraph>

              <Paragraph>
                He left his parents home at 14 years of age, being drafted to
                play indoor volleyball at a team based on the capital of the
                state where he was born, Mato Grosso do Sul. He lived with other
                boys at the campus of the club, 150 miles away from home. With
                his outstanding performance, Benjamin was soon drafted by bigger
        ...
        <div className={`${s.container} ${s.containerSecondary}`}>
          ...
          <div className={s.textContainer}>
            <Paragraph>
              ...
              National Tour. In 2000, they were Brazilian National Champions and
              in 2000 and 2002 Benjamin was elected MVP of the Brazilian
              National Tour, which at the time included names such as Ricardo
              Santos and Emanuel Rego. In 2001, 2002 and 2003, Benjamin & Marcio
